    ...
    return (
      <div>
        ...
        <div className="gridContainer">
          ...
          <div className="two">
            <div className="textheader">Appropriate Topics</div>
            ...
            <div className="ulcontainer">
              <div>
                <ul className="list">
                  ...
                  <li className="licontent">Rule of Law</li>
                  <li className="licontent">
                    Gender, Sexuality & Social Justice
                  </li>
                  <li className="licontent">Accountability & Transparency</li>
                  <li className="licontent">
                    International, Social, Cultural & Economic
                  </li>
                  <li className="licontent">Boundaries</li>
                  <li className="licontent">International Migration</li>
                  <li className="licontent">Cybercrime</li>
                  <li className="licontent">Film Studies</li>
                  <li className="licontent">Religious Studies</li>
                </ul>
              </div>
              <div className="column2">
                <ul className="list">
                  <li className="licontent">Visual Culture</li>
                  <li className="licontent">Linguistics</li>
                  <li className="licontent">History</li>
                  <li className="licontent">Medicine</li>
                  <li className="licontent">Business</li>
                  <li className="licontent">Education</li>
                  <li className="licontent">Political Science</li>
                  <li className="licontent">Sociology</li>
                  <li className="licontent">Criminal Justice/Criminology</li>
                  <li className="licontent">Information Technology</li>
                </ul>
              </div>
            </div>
          </div>
